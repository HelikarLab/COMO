...
read_counts_matrix <- function(
  counts_matrix_filepath,
  config_filepath,
  info_filepath,
  context_name
) {
...
TPM_quant_filter <- function(SampMetrics, filt_options, context_name, prep) {
    ...
    for (i in 1:length(SampMetrics)) {
        ...
        dir.create(file.path(
          "/Users/joshl/Downloads/COMO_python/output/rnaseqR",
          context_name, prep
        ...
        tpm_fname <- file.path(
          ...
          context_name,
          prep,
          paste0("TPM_Matrix_", prep, "_", study_number, ".csv")
        )
...
filter_counts <- function(SampMetrics, technique, filt_options, context_name, prep) {
    print(paste("technique: ", technique))
    print(paste("filt_options", filt_options))
    print(paste("context_name", context_name))
    print(paste("prep", prep))
    switch(
      technique,
...
save_rnaseq_tests <- function(
  ...
  min_zfpkm = -3
    ...
    SampMetrics <- read_counts_matrix(
      counts_matrix_file,
      config_file,
      info_file,
      context_name
...
save_rnaseq_tests(
  counts_matrix_file = "/Users/joshl/Downloads/COMO_python/input/gene_counts_matrix_total_naiveB.csv",
  config_file = "/Users/joshl/Downloads/COMO_python/input/trnaseq_data_inputs_auto.xlsx",
  out_file = "/Users/joshl/Downloads/COMO_python/output/naiveB_R.csv",
  info_file = "/Users/joshl/Downloads/COMO_python/input/gene_info.csv",
  context_name = "naiveB",
)

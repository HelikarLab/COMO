...
dgeAnalysis <- function(SampMetrics, test_name, tissue_name, disease_name) {
    ...
    dir.create(file.path(work_dir, "data", "results", tissue_name, disease_name),
               showWarnings = FALSE
    )
    write.csv(cbind(ensembl, tmm),
              file.path(work_dir, "data", "results", tissue_name, disease_name, "TMM_Matrix.csv")
    )
    
    # MDS Plot
    plotname <- file.path(work_dir, "data", "results", tissue_name, disease_name, "MDS_plot.jpg")
    ...
    # BCV plot
    plotname <- file.path(work_dir, "data", "results", tissue_name, disease_name, "BCV_plot.jpg")
    ...
    for (i in 2:glen) {
        ...
        # smear plot
        plotname <- file.path(work_dir, "data", "results", tissue_name, disease_name, "smear_plot.jpg")

...
def main(argv):
    ...
    parser.add_argument("-nr", "--n-neighbors-rep",
                        type=str or float,
                        required=False,
                        default="default",
                        dest="n_neigh_rep",
    ...
    parser.add_argument("-nb", "--n-neighbors-batch",
                        type=str or float,
                        required=False,
                        default="default",
                        dest="n_neigh_batch",
    ...
    parser.add_argument("-nc", "--n-neighbors-context",
                        type=str or float,
                        required=False,
                        default="default",
                        dest="n_neigh_cont",
    ...
    parser.add_argument("-c", "--min-count",
                        type=str or int,
                        required=False,
                        default="default",
                        dest="min_count",

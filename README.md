...
[![Unit Tests](https://github.com/HelikarLab/COMO/actions/workflows/unit_tests.yml/badge.svg?branch=master)](https://github.com/HelikarLab/COMO/actions/workflows/unit_tests.yml)
...
[View the documentation](https://helikarlab.github.io/COMO)
...
- Run docker image and assign 2 CPUs to it.
  - `sudo docker run --cpus=4 -p 8888:8888 --volume=$HOME/gurobi.lic:/opt/gurobi/gurobi.lic:ro  -v /$HOME/LocalComo:/home/jovyan/work/data/local_files --rm --name como --rm -it ghcr.io/helikarlab/como:latest`
